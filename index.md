...
venue: "University of Toronto Robarts Library"        # brief name of host site without address (e.g., "Euphoric State University")
address: "130 St George St, Toronto, ON, M5S 1A5"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
humandate: "March 11, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:30 am -12:30 am"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2019-03-11      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2019-03-11        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Rachel Wang"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Jordan Pedersen", "Sarah Gorman", "Angel Su", "Dominique Glassman"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
<h4>This is the workshop site for the staff OpenRefine workshop.</h4>
...
{% endcomment %}
<p id="requirements">
  <strong>Requirements:</strong> Participants only need to bring their UTorID to log in to the computers in the workshop room. They are also required to abide by
  {% if page.carpentry == "swc" %}
